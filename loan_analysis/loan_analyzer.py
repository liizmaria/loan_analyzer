...
def new_loan(new_future_value, annual_discount_rate, new_remaining_months):
    present_value = new_future_value / (1 + (annual_discount_rate / 12)) ** new_remaining_months
...
for each_loan in loans:
    loan_prices = each_loan["loan_price"]
    if loan_prices <= 500:
        inexpensive_loans.append(loan_prices)
